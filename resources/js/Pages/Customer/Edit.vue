<script setup>
   ...
   const props = defineProps({
    ...
    const form = useForm({
        ...
        'phone_number'  : props.customer.mobile_number,
    ...
    <AdminPanel>
        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <div class="flex items-center">
                ...
                <Link href="#" class="ml-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ml-2 dark:text-gray-400 dark:hover:text-white">Edit</Link>
            </div>
            </li>
        </ol>
        </nav>
